    ...
    <div
      ...
      <div
        ...
        <div style={{ display: 'flex', justifyContent: 'center',  zIndex: 99 }}>
          <div style={{ color: '#BBBFC4', fontSize: 10, fontWeight: 400,position: 'absolute', border: 'solid 2px #dee0e3', borderTop: 0, width: 64, height: 20, borderRadius: 3, display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            Screen
          </div>
        </div>
        <div
